...
const guideDefinitions: GuideDefinition[] = [
  ...
  },
  {
    ...
    catalogSummary: "Review year-group semester schedules and configure HQ reporting events.",
    roles: ["SuperAdmin"],
    ...
    steps: () => [
      ...
      {
        title: "Reporting Event Management",
        description: "Keep manually managed deadlines aligned with the official cohort schedules.",
        bullets: [
          "Verify the semester, academic year and target year group before publishing a WEL window.",
          "Academic Term boundary events are read-only here to preserve one source of truth.",
          "Avoid manual events that duplicate an automatically synchronized term boundary.",
        ],
      },
    ],
  },
